...
const Background = () => {
	...
	useEffect(() => {
		const handleMouseMove = (e: MouseEvent | TouchEvent) => {
			...
			const parentOffset = flashLightRef.current.getBoundingClientRect();
			const cursorX =
				e.type === "touchmove" && "changedTouches" in e
					? e.changedTouches[0].clientX - parentOffset.left
					: (e as MouseEvent).clientX - parentOffset.left;
			const cursorY =
				e.type === "touchmove" && "changedTouches" in e
					? e.changedTouches[0].clientY - parentOffset.top
					: (e as MouseEvent).clientY - parentOffset.top;

			gsap.set(flashLightRef.current, {
		...
		gsap.to(flashLightRef.current, { opacity: 0.9, duration: 5 });
	...
	return (
		<div className="w-screen relative cursor-none">
			<svg
				viewBox="0 0 753.6 500.2"
				className="w-screen relative top-60 -translate-y-1/2"
			>
				<g>
					<radialGradient
						id="SVGID_1_"
					...
					>
						<stop offset="0" style={{ stopColor: "#25BCAF" }} />
						<stop offset="1" style={{ stopColor: "#1857BD" }} />
					</radialGradient>
					...
					<linearGradient
						...
						y2="293.2076"
					>
						<stop offset="0" style={{ stopColor: "#277A9F" }} />
						<stop offset="0.6049" style={{ stopColor: "#294E95" }} />
						<stop offset="1" style={{ stopColor: "#1D3973" }} />
					</linearGradient>
					<path
						fill="url(#SVGID_2_)"
		...
		c0.4,1.5,2.1,2.9,2.9,4.2c-1.6,0-3.3,0.4-4.3,1.7c3.9,4,1.9,3,1,8c3.4,1.2,11.7,0.5,15-1"
					...
					<g id="house">
						<linearGradient
							...
							y2="546.787"
						>
							<stop offset="0" style={{ stopColor: "#0C0A0C" }} />
							<stop offset="1" style={{ stopColor: "#1857BD" }} />
						</linearGradient>
						<path
							fill="url(#SVGID_11_)"
			...
			C142.8,280.3,142.4,284.2,142,288.8z M129.8,280l-0.8,9l-10.9,0.2c0-2.8-0.2-6-0.7-9.5L129.8,280z"
						...
						<radialGradient
							...
							gradientUnits="userSpaceOnUse"
						>
							<stop offset="0" style={{ stopColor: "#B3C691" }} />
							<stop offset="1" style={{ stopColor: "#8DC39C" }} />
						</radialGradient>
						<path
							fill="url(#SVGID_12_)"
			...
			c1.1-0.1,2.2-0.4,3.3-0.8l1,3.4l2-0.2l0.1-4.9c1.4-1,2.6-2.3,3.5-3.9c2.4,2,4.6,3,4.6,3S504.2,327,501.8,320.3z"
						...
						<g>
							<radialGradient
								...
								gradientUnits="userSpaceOnUse"
							>
								<stop offset="0" style={{ stopColor: "#FECA7A" }} />
								<stop offset="0.1347" style={{ stopColor: "#FACA7B" }} />
								<stop offset="0.2792" style={{ stopColor: "#EDC97F" }} />
								<stop offset="0.4284" style={{ stopColor: "#D7C886" }} />
								<stop offset="0.5807" style={{ stopColor: "#B9C68F" }} />
								<stop offset="0.7354" style={{ stopColor: "#93C49A" }} />
								<stop offset="0.89" style={{ stopColor: "#64C1A9" }} />
								<stop offset="1" style={{ stopColor: "#3EBFB4" }} />
							</radialGradient>
		...
		l-0.9,5.7l0.5,10.6L375.6,387.4z"
			...
			<div
				className="bg-black bg-opacity-95 w-screen h-screen absolute top-0 left-0 opacity-0 pointer-events-none"
				id="flashlight"
				ref={flashLightRef}
			></div>
		</div>
